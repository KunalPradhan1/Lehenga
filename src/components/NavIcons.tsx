...
const NavIcons = () => {
    ...
    return (
        <div className="flex items-center justify-between gap-4 xl:gap-6 relative">
            ...
            {isProfileOpen && <div className="absolute p-4 rounded-md bg-white top-12 left-0 text-small shadow-[0_3px_10px_rgb(0,0,0,0.2)] z-20">
            ...
            <div className="relative cursor-pointer" onClick={() => setIsCartOpen((prev) => !prev)}>
                ...
                <div className="absolute -top-4 -right-4 w-6 h-6 bg-lehenga rounded-full text-white text-sm flex items-center justify-center">{counter}</div>
            </div>
            {isCartOpen && (
                <CartModel />
            )}
