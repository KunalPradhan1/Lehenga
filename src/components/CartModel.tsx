...
import { currentCart, shippingOptions } from "@wix/ecom";
                    ...
                    <div className="flex flex-col justify-between w-full">
                        ...
                        <div className="">
                            ...
                            <div className="flex items-center justify-between gap-8">
                                ...
                                <div className="p-1 bg-gray-50 rounded-sm flex items-centered gap-1">{item.quantity && item.quantity > 1 && <div className="text-xs text-green-500">{item.quantity} x </div>}${item.price?.amount}</div>
